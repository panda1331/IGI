...
def index(request):
    ...
    return render(request, 'main/index.html', context={'last_article': last_article, 'quote': quote, 'fact': fact, 'user_tz': user_tz_name, 'now_local': now_local, 'now_utc': now_utc})
